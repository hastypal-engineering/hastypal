...
/*
================================================================================
TELEGRAM SHOW CONFIRMATION COMMAND
================================================================================
*/

func (s *Service) showConfirmation(ctx context.Context, update TelegramUpdate) error {
	ack := AnswerCallbackQuery{CallbackQueryId: update.CallbackQuery.Id}
